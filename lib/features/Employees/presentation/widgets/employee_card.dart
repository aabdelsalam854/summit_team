    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Flexible(
                  child: AspectRatio(
                    aspectRatio: 1.8, // يحافظ على شكل الدائرة
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        child: FittedBox(
                          ...
                          child: Text(
                            ...
                            style: AppStyles.styleMedium20(
                              context,
                            ).copyWith(color: _getRoleColor(employee.role)),
                          ),
                        ),
                      ),
                    ),
          ...
          // Details Section (NO Expanded here)
          Padding(
            padding: const EdgeInsets.all(16),
            child: Column(
              spacing: 10,
            ...
            children: [
              Text(
                ...
                style: AppStyles.styleRegular12(
                  context,
                ).copyWith(color: const Color(0xFF95A5A6)),
              ),
              Text(
                value,
                maxLines: 1,
